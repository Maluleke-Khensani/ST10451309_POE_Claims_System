        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Document1FileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Document1FileData = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    Document2FileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Document2FileData = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
